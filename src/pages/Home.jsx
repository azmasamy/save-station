    ...
    <main className="max-w-screen-lg px-4 py-8 md:pt-24 md:pb-16 mx-auto relative">
      ...
      <section className="flex flex-col-reverse gap-4 md:flex-row justify-between items-center">
        <div className="space-y-5">
          ...
          <h2 className="text-3xl font-bold max-w-[36ch] leading-tight">
            <span>Never lose access to your account!</span>
          </h2>
          ...
          <li className="w-full relative mb-6 sm:mb-0 flex sm:block flex-col items-center text-center sm:items-start sm:text-left">
            ...
            <div className="mt-3 sm:pr-8">
              ...
              <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                , that means no one have access to your data even us, the
                developers. Login to start the backup process.
              </p>
            </div>
          </li>
          <li className="w-full relative mb-6 sm:mb-0 flex sm:block flex-col items-center text-center sm:items-start sm:text-left">
            ...
            <div className="mt-3 sm:pr-8">
              ...
              <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                SaveStation requires some code to be deployed into your account
                to allow the recovery process later. It's a click of a button.
              </p>
            </div>
          </li>
          <li className="w-full relative mb-6 sm:mb-0 flex sm:block flex-col items-center text-center sm:items-start sm:text-left">
            ...
            <div className="mt-3 sm:pr-8">
              ...
              <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                your account after a certain date you specify. You can change it
                anytime.
              </p>
            </div>
          </li>
          ...
          <li className="w-full relative mb-6 sm:mb-0 flex sm:block flex-col items-center text-center sm:items-start sm:text-left">
            ...
            <div className="mt-3 sm:pr-8">
              ...
              <p className="text-base font-normal text-gray-500 dark:text-gray-400">
                ...
                account, only if you are allowed to.
              </p>
            </div>
          </li>
          <li className="w-full relative mb-6 sm:mb-0 flex sm:block flex-col items-center text-center sm:items-start sm:text-left">
